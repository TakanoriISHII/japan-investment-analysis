...
│  - NRC/FAA/DoD認証: 取消されない限りstable/を使用                    │
│  - 参入障壁: 構造的要因は年単位で安定                               │
...
┌────────────────────────────────────────────────────────────────┐
│ ✓ 一次情報源での検証が必要な項目                              │
│   → SEC, SAM.gov, DoD, Federal Registerで直接確認            │
│                                                                │
│ ✓ 矛盾が検出された数値・情報                                  │
...
| # | カテゴリー | 内容 | 用途 |
|---|-----------|------|-----|
| A | **地政学** | 米中、台湾、輸出規制、制裁 | 市場リスク、ドメイン評価 |
| B | **市場リスクシグナル** | FRB政策、レバレッジ、バリュエーション、VIX | 市場リスク分析 |

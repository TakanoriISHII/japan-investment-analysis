# CLAUDE.md - 米国マルチドメイン・コンバージェンス分析
...
**マルチドメイン・コンバージェンスにおける情報の非対称性を活用する** — 市場が単一ドメインに焦点を当てることで過小評価している、6ドメインの収束点で構造的優位性を持つ米国企業を特定する。
...
| 相対要因 | 内容 | 例 |
|---------|------|-----|
| 競合動向 | ライバルの追い上げ/撤退 | AMD追い上げ → NVDA評価下方修正 |
| 情勢変化 | 政策転換/技術革新 | IRA追加予算 → エネルギー企業上方修正 |
